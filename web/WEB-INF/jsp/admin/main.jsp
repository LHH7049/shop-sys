...
<script language="JavaScript" src="${pageContext.request.contextPath}/js/newPage.js"></script>
<script language="JavaScript" src="${pageContext.request.contextPath}/js/goodTableJS.js"></script>
<script language="JavaScript" src="${pageContext.request.contextPath}/js/goodsType.js"></script>
